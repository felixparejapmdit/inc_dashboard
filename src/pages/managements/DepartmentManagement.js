            ...
            <>
              <Box overflowX="auto">
                <Table variant="simple">
                  <Thead bg="gray.50">
                    <Tr>
                      <Th p={6} color="gray.600" fontSize="xs" fontWeight="black" textTransform="uppercase" letterSpacing="widest">Department Name</Th>
                      <Th p={6} color="gray.600" fontSize="xs" fontWeight="black" textTransform="uppercase" letterSpacing="widest">Code / ID</Th>
                    ...
                    <AnimatePresence>
                      {paginatedData.map((dept) => (
                        ...
                        >
                          <Td p={6}>
                            <HStack spacing={4}>
                              <Avatar size="sm" name={dept.name} bg="blue.500" color="white" fontWeight="bold" />
                              <Text fontWeight="black" color="gray.800" fontSize="md">{dept.name}</Text>
                            </HStack>
                          </Td>
                          <Td p={6}>
